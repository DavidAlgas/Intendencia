...
public class tab2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Query filtramos = refItems.orderByChild("marca").equalTo("Campingaz");
        itemsRV = (RecyclerView) tab2.findViewById(R.id.ListadoItemsButano);

        itemsRV.setHasFixedSize(true);
        itemsRV.setLayoutManager(new LinearLayoutManager(getActivity()));


        adaptadorItems = new FirebaseRecyclerAdapter<Item, ItemsViewHolder>(Item.class, R.layout.linea_items, ItemsViewHolder.class, filtramos) {
            @Override
        ...
        filtramos.addChildEventListener(new ChildEventListener() {
            @Override
